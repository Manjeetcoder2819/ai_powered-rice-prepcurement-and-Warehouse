...
class BatchModel(Base):
    ...
    bag_media_url    = Column(String, default="")
    bag_media_type   = Column(String, default="")   # image|video
    damage_media_url = Column(String, default="")
    damage_class     = Column(String, default="")   # healthy|torn|wet|open_leaking
    damage_confidence = Column(Float, default=0.0)
    detection_source  = Column(String, default="simulated")  # simulated|cv_model
