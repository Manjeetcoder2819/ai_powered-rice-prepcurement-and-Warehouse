...
import LiveGateVerify from "./LiveGateVerify";
...
export default function VehiclesPage() {
  ...
  const handleVerify = async (override = false) => {
    ...
    try {
      const res = await simulateGateVerify({
  ...
  return (
    <div style={pageStyle}>
      ...
      {/* =========================================================
          REAL AI GATE VERIFICATION (upload an actual photo)
      ========================================================= */}
      <LiveGateVerify />
          ...
          <table style={tableStyle}>
            ...
            <tbody>
              {vehicles.map((vehicle, index) => {
                ...
                return (
                  <tr key={vehicle.id ? `veh-${vehicle.id}-${vehicle.vehicle_id || index}` : `veh-${index}`}>
