...
import LiveBagScan from './LiveBagScan'
...
export default function BagsPage() {
  ...
  useEffect(() => {
    ...
    const farmerTimer = setTimeout(loadFarmers, 0)
    return () => clearTimeout(farmerTimer)
  }, [])
  ...
  return (
    <div style={pageStyle}>
      ...
      {/* =========================================================
          REAL AI BAG SCAN (upload an actual image/video)
      ========================================================= */}
      <LiveBagScan
        farmers={farmers}
        onScanComplete={() => {
